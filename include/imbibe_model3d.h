 ...
 *
 ******************************************************************************/
/*! \file imbibe_model3d.h

    Top level function header for calling the imbibition constant curvature model in 3D. 
...
#ifndef INCLUDED_IMBIBE_MODEL3D_H
#define INCLUDED_IMBIBE_MODEL3D_H

void  imbibe_model3d(Options *,QSS_DataArrays  *,Grid  *,FILE *);
