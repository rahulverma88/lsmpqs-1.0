/*
 * File:        qss_grid.h
 * Description: Header file for grid data structures that support
 *              QSSLIB calculations
 */

#ifndef included_qss_grid_h
#define included_qss_grid_h
...
typedef struct _Grid {
   ...
   QSSLIB_REAL   x_lo_ghostbox[3]; 
   QSSLIB_REAL   x_hi_ghostbox[3];
  ...
  QSSLIB_REAL beta, gamma;
  
  
} Grid;
 
 
/*! \enum QSSLIB_SPATIAL_DERIVATIVE_ACCURACY_TYPE
 *
...
typedef enum { LOW = 0, MEDIUM = 1, HIGH = 2, VERY_HIGH = 3 } 
  QSSLIB_SPATIAL_DERIVATIVE_ACCURACY_TYPE;
...
Grid *createGridSetDx(int num_dims, QSSLIB_REAL dx, 
                      QSSLIB_REAL *x_lo, QSSLIB_REAL *x_hi,
...
Grid *createGridSetDxDyDz(int num_dims, 
                          QSSLIB_REAL dx, QSSLIB_REAL dy, QSSLIB_REAL dz,
                          QSSLIB_REAL *x_lo, QSSLIB_REAL *x_hi,
                          QSSLIB_SPATIAL_DERIVATIVE_ACCURACY_TYPE accuracy);
/*!
