...
*/
#ifndef included_qss_initialization2d_h
#define included_qss_initialization2d_h
...
void createLine(
  QSSLIB_REAL *phi, 
  QSSLIB_REAL normal_x, QSSLIB_REAL normal_y,
  QSSLIB_REAL point_x, QSSLIB_REAL point_y,
  Grid *grid);
...
void createIntersectionOfHalfSpaces2d(
  QSSLIB_REAL *phi, int num_half_spaces,
  QSSLIB_REAL *normal_x, QSSLIB_REAL *normal_y,
  QSSLIB_REAL *point_x, QSSLIB_REAL *point_y,
  Grid *grid);
...
void createCircle(
  QSSLIB_REAL *phi, 
  QSSLIB_REAL center_x, QSSLIB_REAL center_y,
  QSSLIB_REAL radius,
  int inside_flag,
  Grid *grid);
...
void createIntersectionOfCircles(
  QSSLIB_REAL *phi, int num_circles, 
  QSSLIB_REAL *center_x, QSSLIB_REAL *center_y,
  QSSLIB_REAL *radius,
  int *inside_flag,
  Grid *grid);
...
void createRectangle(
  QSSLIB_REAL *phi,
  QSSLIB_REAL corner_x, QSSLIB_REAL corner_y,
  QSSLIB_REAL side_length_x, QSSLIB_REAL side_length_y,
  int inside_flag,
  Grid *grid);
