 ...
 *
 ******************************************************************************/
/*! \file drain_model2d.h

    Top level function header for calling the drainage constant curvature model in 2D. 
...
#ifndef INCLUDED_DRAIN_MODEL2D_H
#define INCLUDED_DRAIN_MODEL2D_H

void  drain_model2d(Options *,QSS_DataArrays  *,Grid  *,FILE *);
