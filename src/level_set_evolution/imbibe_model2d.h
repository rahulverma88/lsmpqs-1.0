 ...
 *
 ******************************************************************************/
/*! \file imbibe_model2d.h

    Top level function header for calling the imbibition constant curvature model in 2D. 
...
#ifndef INCLUDED_IMBIBE_MODEL2D_H
#define INCLUDED_IMBIBE_MODEL2D_H

void  imbibe_model2d(Options *,QSS_DataArrays  *,Grid  *,FILE *);
